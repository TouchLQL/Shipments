...
$(document).ready(function () {
    ...
    myGrid = {
        ...
        columns: [
            ...
            { data: "order_id", title: "order_id" },
            { data: "lang", title: "lang" },
            { data: "merchant_name", title: "merchant_name" },
            { data: "msisdn", title: "msisdn" },
            { data: "accessTime", title: "accessTime" },
            { data: "total_price", title: "total_price" },
            { data: "callbacktime", title: "callbacktime" }
        ],
        order: [[0, 'desc']],
        data: {},
        ajax: function (data, callback, settings) {
            //封装请求参数
            var reUrl = '/Business/GetCodaBillingList';
...
function LogDelete() {
    ...
    $.ajax({
        ...
        url: "/Business/CodaBillingDelete?id=" + seletedItem.id + "&t=" + new Date().getTime(),
        data: "",
