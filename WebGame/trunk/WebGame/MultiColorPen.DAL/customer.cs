...
namespace MultiColorPen.DAL
{
	...
	public partial class customer
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "customer"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(MultiColorPen.Model.customer model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into customer(");
			strSql.Append("name,address,tel,is_del,person,mark)");
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("?person", MySqlDbType.VarChar,20),
					new MySqlParameter("?mark", MySqlDbType.VarChar,255)};
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MultiColorPen.Model.customer model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public MultiColorPen.Model.customer GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,name,address,tel,is_del,person,mark from customer ");
			strSql.Append(" where id=?id");
			MySqlParameter[] parameters = {
					new MySqlParameter("?id", MySqlDbType.Int32)
			};
			...
			MultiColorPen.Model.customer model=new MultiColorPen.Model.customer();
		...
		/// 得到一个对象实体
		/// </summary>
		public MultiColorPen.Model.customer DataRowToModel(DataRow row)
		{
			MultiColorPen.Model.customer model=new MultiColorPen.Model.customer();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,name,address,tel,is_del,person,mark ");
