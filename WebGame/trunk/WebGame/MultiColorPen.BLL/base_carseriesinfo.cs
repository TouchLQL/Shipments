...
namespace MultiColorPen.BLL {
	...
	{
		private MultiColorPen.DAL.base_carseriesinfo dal= new MultiColorPen.DAL.base_carseriesinfo();
		public base_carseriesinfo(string connStr="")
		{
		}
		...
		{
			return dal.Exists(seriescode);
		}

		/// <summary>
		/// 增加一条数据
		/// </summary>
		public int Add(MultiColorPen.Model.base_carseriesinfo model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public int Update(MultiColorPen.Model.base_carseriesinfo model)
		{
		...
		/// 获得对象数组
		/// </summary>
		public List<MultiColorPen.Model.base_carseriesinfo> GetModelList(string strWhere)
		{
		...
		/// </summary>
		public List<MultiColorPen.Model.base_carseriesinfo> DataTableToList(DataTable dt)
		{
			List<MultiColorPen.Model.base_carseriesinfo> modelList = new List<MultiColorPen.Model.base_carseriesinfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MultiColorPen.Model.base_carseriesinfo model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new MultiColorPen.Model.base_carseriesinfo();					
