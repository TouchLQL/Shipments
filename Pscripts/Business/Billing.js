...
$(document).ready(function () {
    ...
    myGrid = {
        ...
        columns: [
            ...
            { data: "TransactionCode", title: "Transaction Code" },
            { data: "accessTime", title: "access time" },
            { data: "callbackTime", title: "callback time" },
            { data: "payment_details", title: "payment_details" },
            { data: "currency", title: "currency" },
            { data: "mobile", title: "Mobile" },
            { data: "amount", title: "Amount" },
            { data: "paytime", title: "PayTime" }
        ],
        order: [[0, 'desc']],
        data: {},
        ajax: function (data, callback, settings) {
            //封装请求参数
            var reUrl = '/Business/GetBillingList';
...
function LogDelete() {
    ...
    $.ajax({
        ...
        url: "/Business/BillingDelete?id=" + seletedItem.id + "&t=" + new Date().getTime(),
        data: "",
